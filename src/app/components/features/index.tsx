  ...
  return (
    <div className="max-w-lg mx-auto px-2 pt-5 pb-20">
      <div className="flex justify-center my-10">
        <Image alt="" src={multi_chain} />
      </div>
      <div className="flex justify-center gap-3 md:justify-between flex-wrap my-10">
        <Image alt="" className="my-10 md:my-0" src={kyc} />
        <Image alt="" className="my-10 md:my-0" src={confirmation} />
      </div>
      <div className="flex justify-center gap-3 md:justify-between flex-wrap mt-10">
        <Image alt="" className="my-10 md:my-0" src={rate} />
        <Image alt="" className="my-10 md:my-0" src={mix_eth_weth} />
      </div>
    </div>
  );
}
