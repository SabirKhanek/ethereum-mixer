...
export function Features() {
    return (
        <div className="max-w-lg mx-auto pt-5 pb-20">
            <div className="flex justify-center my-10"><img src={multi_chain} /></div>
            ...
            <div className="flex justify-center md:justify-between flex-wrap mt-10">
